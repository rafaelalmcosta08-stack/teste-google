...
export const units: Unit[] = [
  ...
  },
  {
    ...
    descricao:
      'Unidade de elite responsável por ações táticas de grande porte. Especializada em operações de alto risco, resgate de reféns e situações de crise que exigem máxima força e precisão.',
    icon: Target,
